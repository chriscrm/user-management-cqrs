...
public class AxonConfig {
    ...
    @Bean
    TokenStore tokenStore(Serializer serializer) {
    ...
    @Bean
    EventStorageEngine storageEngine(MongoClient client) {
    ...
    EmbeddedEventStore eventStore(EventStorageEngine storageEngine) {
        ...
        return EmbeddedEventStore.builder()
                ...
                .messageMonitor(configurer.buildConfiguration().messageMonitor(EventStore.class, "eventStore"))
                .build();
